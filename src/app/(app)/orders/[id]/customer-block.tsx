...
import {
  CustomerSheet,
  type CustomerPick,
} from "@/app/(app)/orders/new/customer-sheet";
import type { CustomerOption } from "@/app/(app)/orders/new/types";
import { setOrderCustomerAction, updateCustomerAction } from "@/app/(app)/orders/actions";
